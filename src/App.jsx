    ...
    <div className="px-[50px] py-[24px]">
      <nav className="flex items-center justify-between shadow-inner rounded-2xl bg-[#1B1B1B] p-[16px_16px_16px_32px]">
        ...
        <div className="flex items-center gap-[20px]">
          ...
          <div className="rounded-[100px] py-[7px] px-[21px] bg-[#242424]">
            Contact Me
          </div>
        </div>
      </nav>
      ...
      <section className="flex w-full mt-[24px] gap-[1%] h-[40vw]">
        ...
        <div className="rounded-[20px] bg-[#1B1B1B] w-1/2 flex flex-col items-center justify-center px-[70px] py-[140px] text-center">
          ...
          <h2 className="text-[rgba(255_255_255_40)] text-[28px] center mt-4">
            A passionate SaaS product designer based in the vibrant city of New
            York.
          </h2>
...
function Project() {
  return (
    <div className="flex flex-col items-center justify-center">
      <div className="rounded-md shadow-sm text-[#7e43fb] px-2 py-1">
        PROJECTS
      </div>
  ...
  return (
    <div className="flex items-center p-[1.5rem] bg-[#1B1B1B] gap-[2rem] rounded-xl">
      <img
        src="img.webp"
        alt=""
        className="max-w-[30rem] max-h-[20rem] aspect-square hover:scale-105 ransition-all duration-500 cursor-pointer"
      />
      ...
      <div className="p-[2rem]">
        <h5 className="text-[36px] font-medium">
          How To Build and Grow Your business with design
        </h5>
        <p className="font-[32px]">
          Frustrated with building and managing software project in high growth
          company,ourselves we founded
        </p>
      </div>
    </div>
  );
...
function Footer() {
  return (
    <section className="flex mt-[10vh] bg-[#111111] justify-center">
      <div className="bg-[#111111] w-auto text-center p-5">
        <div className="bg-[#1B1B1B] p-2 pt-4 pb-3 rounded-xl">
          <img
            src="Image [p-image].png"
            alt=""
            className="z-20 h-[100px] relative mt-[-50px] m-auto rounded-lg bg-[#a39f9f] p-1"
          />
          <h1 className="mt-[30px] text-[30px]">Roger Hill</h1>
          <p className="w-[30rem]">
            I believe in the power of design to transform ideas into tangible,
            user-friendly software.
          </p>
        </div>
        <div className="flex justify-center gap-5 mt-4">
          <div className="bg-[#a39f9f] p-1 rounded-lg">
            <img src="Image [p-image].png" alt="" className="w-[100px]" />
          </div>
          <div className="bg-[#a39f9f] p-1 rounded-lg">
            <img src="Image [p-image].png" alt="" className="w-[100px]" />
          </div>
      ...
      <div className="bg-[#1B1B1B] w-[40rem] mt-5 mb-5 flex justify-items-center rounded-xl">
        <div className="w-fit m-auto text-center">
          <h1 className="text-[50px]">Got a Project in Mind ?</h1>
          <h1 className="text-[grey] text-[40px]">Let's Talk</h1>
          <button className="bg-[#f2f23f] p-[1rem] pr-[2.5rem] pl-[2.5rem] rounded-2xl text-black font-bold mt-1">
            Book a free call {`->`}
          </button>
        </div>
      </div>
